...
def rest():
    if pokemon_level < 5:
        print(" Gastly is level: " + str(pokemon_level))
        gastly()
    if pokemon_level >= 5 and pokemon_level < 15:
        print(" Haunter is level: " + str(pokemon_level))
        haunter()
    if pokemon_level > 14:
        print(" Gengar is level: " + str(pokemon_level))
        gengar()
...
def evolution_2():
    global pokemon_name
    print("Gastly has now evolved into Haunter")
    pokemon_name == "haunter"
    haunter()

def evolution_3():
    global pokemon_name
    print("Haunter has now evolved into Gengar")
    pokemon_name == "gengar"
    gengar()
